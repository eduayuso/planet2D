...
public abstract class Page extends Group {
	...
	public Page(PageType type) {
		...
		this.setSize(Screen.getWidth(), Screen.getHeight() - Editor.window.mainToolBar.getHeight() - Editor.window.pagesTabs.getHeight());
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		// Top border
		this.frameBorder.draw(batch, this.getX(), this.getY() + this.getHeight() - 4, this.getWidth(), 2);
	...
	public static String typeToString(PageType type) {
		...
		if (type == PageType.WELCOME) return "Welcome";
